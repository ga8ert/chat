...
class Constants {
  ...
  static const Color fProjectColor = Color.fromARGB(255, 245, 250, 253);
  static const Color sProjectColor = Color.fromARGB(255, 1, 103, 125);
  static const Color tProjectColor = Color.fromRGBO(241,240,240,150);
...
extension MessageEnumExtension on String{
  MessageEnum toMessageEnum(){
    switch(this) {
      case 'text': return MessageEnum.text;
